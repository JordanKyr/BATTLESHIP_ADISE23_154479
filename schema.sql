...
INSERT INTO `game_status` (`game_stat`, `p_turn`, `result`, `last_change`) VALUES
...
CREATE TABLE IF NOT EXISTS `projection` (
  ...
  CONSTRAINT `fk_type2` FOREIGN KEY (`player_id`) REFERENCES `players` (`player_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table battleships.projection: ~190 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ships` (
  ...
  CONSTRAINT `fk_type3` FOREIGN KEY (`player_id`) REFERENCES `players` (`player_id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `targets` (
  ...
  CONSTRAINT `fk_type4` FOREIGN KEY (`player_id`) REFERENCES `players` (`player_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
